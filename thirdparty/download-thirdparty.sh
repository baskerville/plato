...
wget -qO- http://www.ijg.org/files/jpegsrc.v9b.tar.gz | tar xz --strip-components=1 -C libjpeg
...
wget -qO- https://github.com/uclouvain/openjpeg/archive/v2.1.1.tar.gz | tar xz --strip-components=1 -C openjpeg 
wget -qO- https://download.savannah.gnu.org/releases/freetype/freetype-2.9.tar.gz | tar xz --strip-components=1 -C freetype2 
wget -qO- https://github.com/harfbuzz/harfbuzz/archive/1.7.5.tar.gz | tar xz --strip-components=1 -C harfbuzz 
wget -qO- https://mupdf.com/downloads/archive/mupdf-1.12.0-source.tar.gz | tar xz --strip-components=1 -C mupdf 
