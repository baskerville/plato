...
declare -A urls=(
	...
	["openjpeg"]="https://github.com/uclouvain/openjpeg/archive/v2.4.0.tar.gz"
	["jbig2dec"]="https://github.com/ArtifexSoftware/ghostpdl-downloads/releases/download/gs9533/jbig2dec-0.19.tar.gz"
	# Fonts
	["freetype2"]="https://download.savannah.gnu.org/releases/freetype/freetype-2.12.0.tar.gz"
	["harfbuzz"]="https://github.com/harfbuzz/harfbuzz/archive/3.0.0.tar.gz"
	# Documents
	...
	["mupdf"]="https://mupdf.com/downloads/archive/mupdf-1.19.1-source.tar.gz"
)
